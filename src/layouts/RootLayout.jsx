...
export const RootLayout = () => {
  ...
  const breakpointWidth = 780;

  // Browser resize event.
  useEffect(() => {
    const handleResize = () => {
      const currentWidth = window.innerWidth;
      // console.log("Window resized to:", currentWidth);
  ...
  // Allow scroll or not.
  useEffect(() => {
    if (windowWidth <= breakpointWidth && isHamburgerMenuClicked === true) {
      document.body.style.overflow = "hidden";
    } else {
      document.body.style.overflow = "";
    }
  }, [windowWidth, isHamburgerMenuClicked]);

  // Open and close dropdown nav.
  const handleHamburgerClick = () => {
    setIsHamburgerMenuClicked((prev) => !prev);
    // console.log("isHamburgerMenuClicked ", isHamburgerMenuClicked);
  };
    ...
    <>
              ...
              <header className="header">
                <div className="header__wrap">
                  <div className="header__container">
                    ...
                    <ButtonCTA
                      extraClass={"header__cta"}
                      ctaName={"Request Invite"}
                    />
                    <div
              ...
              >
                ...
                >
                  <div className="links__wrap">
                    ...
                    <NavLink className="links__item" to="blog">
                      Blog
                    </NavLink>
                    <NavLink className="links__item" to="careers">
                      Careers
                    </NavLink>
                  </div>
                  {isHamburgerMenuClicked === true ? (
                    <ButtonCTA extraClass={""} ctaName={"Request Invite"} />
                  ) : (
                    ""
                  )}
                </div>
      ...
      <div
        className={`page__overlay ${
          windowWidth <= breakpointWidth && isHamburgerMenuClicked === true
            ? "page__overlay-show"
            : ""
        }`}
      ></div>
            ...
            <div className="footer__wrap">
              <div className="footer__container">
                <div className="footer__content">
                  {/* Footer item */}
                  <div className="footer__content-item footer__content-item-1">
                    <a href="#" className="footer__logo">
                      <img src={logoWhite} alt="Easybank logo" />
                    </a>
                    <div className="footer__social-links">
                      <a href="#" className="footer__social-links-item">
                        <svg
                  ...
                  {/* Footer item */}
                  <div className="footer__content-item footer__content-item-2">
                    <div className="footer__links">
                      <NavLink to="about" className="footer__links-item">
                        About
                      </NavLink>
                      <NavLink to="contact" className="footer__links-item">
                        Contact
                      </NavLink>
                      <NavLink to="blog" className="footer__links-item">
                        Blog
                      </NavLink>
                      <NavLink to="careers" className="footer__links-item">
                        Careers
                      </NavLink>
                      <NavLink to="/" className="footer__links-item">
                        Support
                      </NavLink>
                      <NavLink to="/" className="footer__links-item">
                        Privacy Policy
                  ...
                  {/* Footer item */}
                  <div className="footer__content-item footer__content-item-3">
                    <div className="footer__cta request-invite-cta">
